function addProductToFavorites(e) {
	...
	var addUrl = window.location.href.indexOf('eshop') > 0 ? "/eshop/Account/AddProductToFavorites?productId=" : "/Account/AddProductToFavorites?productId=";
	var removeUrl = window.location.href.indexOf('eshop') > 0 ? "/eshop/Account/RemoveProductFromFavorites?productId=" : "/Account/RemoveProductFromFavorites?productId=";
...
function getFavoritesCount() {
	var getUrl = window.location.href.indexOf('eshop') > 0 ? "/eshop/Account/GetFavoritesCount" : "/Account/GetFavoritesCount";
...
function favouritesReportClick() {
	location.href = window.location.href.indexOf('eshop') > 0 ? "/eshop/Account/FavouritesReport" : "/Account/FavouritesReport";
}
